...
if __name__ == '__main__':
    ...
    show_map(city_df, 'count_work', "Najczęsciej uczęstrzane trasy w dni robocze w okresie 01.04.2023 - 30.04.2023",is_cut=True)
    show_map(city_df, 'count_free', "Najczęsciej uczęstrzane trasy w dni wolne w okresie 01.04.2023 - 30.04.2023",is_cut=True)
    show_map(city_df, 'count_lime', "Najczęsciej uczęstrzane trasy przy użyciu sprzętu firmy Lime w okresie 01.04.2023 - 30.04.2023",is_cut=True)
    show_map(city_df, 'count_lyft', "Najczęsciej uczęstrzane trasy przy użyciu sprzętu firmy Lyft w okresie 01.04.2023 - 30.04.2023",is_cut=True)
    show_map(city_df, 'count_link', "Najczęsciej uczęstrzane trasy przy użyciu sprzętu firmy Link w okresie 01.04.2023 - 30.04.2023",is_cut=True)
